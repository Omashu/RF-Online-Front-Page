 ...
 */
export const purify = (value, props) => dompurify.sanitize(value, props);
 ...
 */
export const purifyText = (value) => purify(value, { ALLOWED_TAGS: ['#text'] });
 ...
 */
export const purifyHtml = (value) => purify(value, {
  ADD_TAGS: ['picture'],
  USE_PROFILES: { html: true },
  ADD_ATTR: ['controls', 'srcset']
});
